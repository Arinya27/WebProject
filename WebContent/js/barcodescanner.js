...
//-------------------------------------------------------------------
  ...
  BarcodeScanner.prototype.stop = function(successCallback, errorCallback, options){

  Cordova.exec(null, null, "org.apache.cordova.barcodeScanner", "stop", [options]);
  
  }
  
//-------------------------------------------------------------------
  
  BarcodeScanner.prototype.swipe = function(successCallback, errorCallback, options){

  Cordova.exec(null, null, "org.apache.cordova.barcodeScanner", "swipe", [options]);
